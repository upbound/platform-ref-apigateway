...
# TODO(turkenh): Consider moving this to upbound/build repo if it is useful for other projects.
...
helm.prepare.$(1): $(HELM_HOME)
	@cp -f $(HELM_CHARTS_DIR)/$(1)/values.yaml.tmpl $(HELM_CHARTS_DIR)/$(1)/values.yaml || true
